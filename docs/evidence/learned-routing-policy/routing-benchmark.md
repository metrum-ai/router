...
Config D and any evidence training must use a GPU host (skip CPU-only). Shadeform
is optional; create cloud GPU instances only when needed and tear them down when
