...
| [routing-benchmark.json](evidence/learned-routing-policy/routing-benchmark.json) | Issue #159 live A/B/C Shadeform overhead with real ONNX CUDA BGE; Harbor load cells included; synthetic_upstream throughput. Config D deferred to #162. |
