...
| Installation | `docs-site/docs/installation/*.md`, `docs-site/docs/operations/deployment-patterns.md` | `README.md`, `docs/DEPLOYMENT.md`, `docs/DOCKER_DEPLOYMENT.md`, package scripts, release validation | Package contents, Docker Compose and binary install paths, runtime paths, health/readiness checks, generic upgrade and rollback guidance |
...
| Runtime package boundaries | `docs-site/docs/reference/architecture-limitations.md`, installation artifact pages | Package validation scripts and Docker/binary packaging | Serving/request-path isolation from optional operator tooling, customer-image binary contents |
...
| Observability and operations | `docs-site/docs/operations/observability.md`, `docs-site/docs/operations/key-generation.md`, `docs-site/docs/evaluation/deployment-readiness.md`, `docs-site/docs/evaluation/operational-acceptance.md` | `docs/DEPLOYMENT.md`, `docs/DOCKER_DEPLOYMENT.md`, `docs/USAGE_REPORTING_PLAYBOOK.md`, `docs/TROUBLESHOOTING_RUNBOOK.md` | Readiness/health/version, metrics, logs, request IDs, deployment validation, backup/rollback, public-safe operational acceptance |
...
| Deployment readiness and operational acceptance | `docs-site/docs/evaluation/deployment-readiness.md`, `docs-site/docs/evaluation/operational-acceptance.md` | `docs/DEPLOYMENT.md`, `docs/DOCKER_DEPLOYMENT.md`, `docs/SMOKE_TEST_MATRIX.md` | Rollout, rollback, smoke tests, package validation, operational cleanup |
...
- Operational evidence lives in `docs/DEPLOYMENT.md`, `docs/DOCKER_DEPLOYMENT.md`, package validation, smoke-test logs, and rollback notes.
